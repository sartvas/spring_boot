...
public class LoadAndSecurityAspect {
    ...
    private void allGetMethodsFromUnilibruary(){}

    @Pointcut("execution(* add*())")
    private void allAddMethodsFromUnilibruary(){}

    @Pointcut("execution(* return*())")
    private void allReturnMethodsFromUnilibruary(){}

    @Pointcut("allGetMethodsFromUnilibruary() || allAddMethodsFromUnilibruary()")
    private void allGetAndReturnMethods(){
        System.out.println("Combination logging");
    }
